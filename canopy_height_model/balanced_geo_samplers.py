...
class HeightDiversityBatchSampler(RandomBatchGeoSampler):
    ...
    def __init__(
        ...
        self.max_diversity_threshold = max_diversity_threshold or sampling_config['max_diversity_threshold']
        self.min_diversity_threshold = min_diversity_threshold or sampling_config['min_diversity_threshold']
        self.max_attempts = max_attempts or sampling_config['max_attempts']
        self.nan_value = nan_value or sampling_config['nan_value']
        self.initial_max_nodata_ratio = initial_max_nodata_ratio or sampling_config['initial_max_nodata_ratio']
        self.initial_max_low_veg_ratio = initial_max_low_veg_ratio or sampling_config['initial_max_low_veg_ratio']
